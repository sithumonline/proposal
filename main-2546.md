...
- Implement protocol with flexibility for kind of peer-to-peer communication.

  Developers should be able to change the protocol as they want and
  build their own applications on top of the protocol. The protocol would be flexible enough to be used for any kind of peer-to-peer communication.
