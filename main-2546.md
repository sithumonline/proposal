...
According to [13] [Link](https://www.cvedetails.com/version-list/1550/2662/1/Kazaa-Kazaa-Media-Desktop.html), the software release information are as follows:
...
Skype is proprietary [10] [Link](https://apps.microsoft.com/store/detail/skype/9WZDNCRFJ364?hl=en-us&gl=us) and it relies on a super node [1] [Link](https://eprints.um.edu.my/4797/). Therefore, it is not suitable for general-purpose communication and the super node makes it centralized.
...
This new protocol is innovative because it provides support for both textual and binary content therefor it can be used for any kind of peer-to-peer communication. Additionally, it provides developers with greater control over the protocol, which is an essential aspect of developing new applications.
